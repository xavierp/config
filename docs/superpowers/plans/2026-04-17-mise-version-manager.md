...
> **Status: COMPLETE** — All tasks done. mise replaces nvm/rbenv, manages node/ruby/python/terraform versions declaratively.
...
- [x] **Step 1: Create the mise module**
...
- [x] **Step 1: Remove `terraform` from `home.packages`**
...
- [x] **Step 2: Remove nvm/rbenv sourcing from `initContent`**
...
- [x] **Step 1: Add mise.nix to imports**
...
- [x] **Step 2: Verify mise is active**
...
- [x] **Step 4: Test project-level override**
...
- [x] **Step 5: Commit spec and plan, open draft PR**
